...
const inventoryTransactionSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['RECEIVING', 'QUARANTINE_HOLD', 'QC_RELEASE', 'QC_FAIL', 'RETURN_TO_VENDOR', 'PUTAWAY_CREATED', 'PUTAWAY_COMPLETE', 'ADJUSTMENT', 'TRANSFER', 'TRANSFER_OUT', 'TRANSFER_IN', 'PICK_EXECUTE', 'PICK_COMPLETE', 'RETURN', 'RETURN_REJECT', 'WRITEOFF', 'REPLENISHMENT_RESERVE', 'REPLENISHMENT_COMPLETE', 'REPLENISHMENT_CANCEL', 'FIFO_OVERRIDE_AUDIT'],
    required: true
  },
