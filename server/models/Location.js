...
const locationSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['AVAILABLE', 'FREE', 'LIBRE', 'OCCUPIED', 'OCUPADO', 'PARTIAL', 'PARCIAL', 'BLOCKED', 'BLOQUEADO', 'MAINTENANCE', 'RESERVED', 'CYCLE_COUNT', 'ACTIVE', 'LOCKED', 'QUARANTINE', 'CUARENTENA'], default: 'AVAILABLE' },
  locationType: { type: String, enum: ['PALLET', 'SHELF', 'FLOOR', 'STAGING', 'OVERFLOW', 'RACK', 'rack', 'RESERVE', 'reserve', 'pallet_floor', 'shelf_box', 'bin', 'pick_face', 'PICK_FACE', 'dispatch', 'returns', 'quarantine', 'blocked'], default: 'pallet_floor' },
  type: { type: String, enum: ['PALLET', 'SHELF', 'FLOOR', 'STAGING', 'OVERFLOW', 'RACK', 'rack', 'RESERVE', 'reserve', 'pallet_floor', 'shelf_box', 'bin', 'pick_face', 'PICK_FACE', 'dispatch', 'returns', 'quarantine', 'blocked'], default: 'pallet_floor' },
