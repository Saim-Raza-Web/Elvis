...
export const putawayService = {
  ...
  complete: async (id: string, payload: { destinationBin?: string; scannedTaskBarcode?: string; scannedBinBarcode?: string; scannedSkuBarcode?: string; executedQty?: number; expiryDate?: string; overrideId?: string; __v?: number }) => {
